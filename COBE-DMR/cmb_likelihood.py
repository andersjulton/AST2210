...
if __name__ == "__main__":
    ...
    print 'Now pre-computing (or fetching) Legendre polynomials for signal covariance'
    p_ell_ij = utils.get_legendre_mat(lmax,x,y,z)
    #np.save("data/Legendre_polynomials", p_ell_ij)    
    #p_ell_ij = np.load("data/Legendre_polynomials.npy")
